...
model MultipleZones
  ...
  .cdl_models.Move.ZoneSetpointControl0.ZoneSetpointSource zoneSetpointSource[nZon](
      occStaHouSta=6, occStaHouEnd=19)
    annotation (Placement(transformation(extent={{-92,-84},{-72,-64}})));
  cdl_models.Move.ZoneSetpointControl0.MultipleZones multipleZoneSetpointControl(
    nZon=nZon,
    delChaSheHea=-0.5556,
    delChaRebHea=0.5556,
    delSheThoHea=0.5556,
