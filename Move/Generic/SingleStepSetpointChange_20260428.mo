...
block SingleStepSetpointChange_20260428 "Single-step setpoint change"
  ...
  Subsequences_20260429.RealEqual reaEquTarSet(alwDev=alwDev)
    "Check if the current setpoint and the target setpoint are equal to each other"
    annotation (Placement(transformation(extent={{-20,140},{0,160}})));
  Subsequences_20260429.RealEqual reaEquDefSet(alwDev=alwDev)
...
end SingleStepSetpointChange_20260428;
