within cdl_models.Move.ZoneSetpointControl.Subsequences.BaseTemperatureSetpointElements.Subsequences.Validation;
model ModeSelection
  extends Modelica.Icons.Example;
  cdl_models.Move.ZoneSetpointControl.Subsequences.BaseTemperatureSetpointElements.Subsequences.ModeSelection
    modeSelection
