...
<p>
This block conducts a single-step setpoint change as follows:
</p>
<ul>
<li>
If the setpoint change enabling input <code>uEna</code> is <code>true</code>, the 
output <code>y</code> equals the allowed maximum setpoint <code>uAllMaxSet</code> 
if the parameter <code>ascSet</code> is set to <code>true</code>, or equals the 
allowed minimum setpoint <code>uAllMinSet</code> if <code>ascSet</code> is set to 
<code>false</code>.
</li>
<li>
