...
model building_3_zone
  ...
  ModelicaRoom modelicaRoom[nZones]
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus[nZones]
    "Weather Data Bus" annotation (Placement(transformation(extent={{-112,-70},
            {-92,-50}}), iconTransformation(extent={{-116,-46},{-96,-26}})));
equation
