...
model reboundSelectionCooling
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput DoReb[nZones]
    annotation (Placement(transformation(extent={{100,-20},{140,20}}),
        iconTransformation(extent={{100,-20},{140,20}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput reachTZonSetMin[nZones]
...
equation
  ...
  connect(not1.y,DoReb)  annotation (Line(points={{50,30},{94,30},{94,0},{120,0}},
        color={255,0,255}));
  connect(reachTZonSetMin, swi.u2) annotation (Line(points={{-122,-70},{-122,
