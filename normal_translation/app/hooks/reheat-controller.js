...
const controller = require("../lib/Buildings/Controls/OBC/ASHRAE/G36/TerminalUnits/Reheat/Controller.js");
const TimeManager = require("../lib/TimeManager");
const instance = controller({ VHeaMax_flow: 0.3, VHeaMin_flow: 0.15, VCooMax_flow: 1.5, VOccMin_flow: 0.15 });
...
module.exports = async ({points}) => {
  ...
  const { VAdjAreBreZon_flow, VAdjPopBreZon_flow, VMinOA_flow, VSet_flow, VZonAbsMin_flow, VZonDesMin_flow, yCO2, yDam, yFloSenAla, yHeaValResReq, yHotWatPlaReq, yLeaDamAla, yLeaValAla, yLowFloAla, yLowTemAla, yVal, yZonPreResReq, yZonTemResReq } = instance(params);
