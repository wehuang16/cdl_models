...
// http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests
...
module.exports = (
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.one
  const oneFn = constant_8c5ba27d({ k: 1 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lesThr1
  const lesThr1Fn = lessthreshold_f64b25e3({ h: posHys, t: 0.1 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr2
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.cooSupTemDif
  const cooSupTemDifFn = subtract_029d2d63({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr
  const greThrFn = greaterthreshold_64a3c4e0({ h: Thys, t: 3 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.truDel
  const truDelFn = truedelay_b49d8a1a({ delayTime: 120 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.two
  const twoFn = constant_8c5ba27d({ k: 2 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr1
  const greThr1Fn = greaterthreshold_64a3c4e0({ h: Thys, t: 2 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.truDel1
  const truDel1Fn = truedelay_b49d8a1a({ delayTime: 120 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lesThr
  const lesThrFn = lessthreshold_f64b25e3({ h: posHys, t: 0.85 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lat
  const latFn = latch_a5aa3a49({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.chiWatRes1
  const chiWatRes1Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.chiWatRes2
  const chiWatRes2Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.chiWatRes3
  const chiWatRes3Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lesThr3
  const lesThr3Fn = lessthreshold_f64b25e3({ h: posHys, t: 0.1 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr5
  const greThr5Fn = greaterthreshold_64a3c4e0({ h: posHys, t: 0.95 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lat3
  const lat3Fn = latch_a5aa3a49({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.intSwi1
  const intSwi1Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.heaSupTemDif
  const heaSupTemDifFn = subtract_029d2d63({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr3
  const greThr3Fn = greaterthreshold_64a3c4e0({ h: Thys, t: 17 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.truDel2
  const truDel2Fn = truedelay_b49d8a1a({ delayTime: 300 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.greThr4
  const greThr4Fn = greaterthreshold_64a3c4e0({ h: Thys, t: 8 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.truDel3
  const truDel3Fn = truedelay_b49d8a1a({ delayTime: 300 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lesThr2
  const lesThr2Fn = lessthreshold_f64b25e3({ h: posHys, t: 0.85 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.lat2
  const lat2Fn = latch_a5aa3a49({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.hotWatRes1
  const hotWatRes1Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.hotWatRes2
  const hotWatRes2Fn = switch_45c83437({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests.hotWatRes3
  ...
  return (
    ...
    const greThr2 = greThr2Fn({ u: uCooCoi_actual });
    ...
    const lesThr = lesThrFn({ u: uCooCoi_actual });
    ...
    const lesThr3 = lesThr3Fn({ u: uHeaCoi_actual });
    ...
    const lesThr2 = lesThr2Fn({ u: uHeaCoi_actual });
