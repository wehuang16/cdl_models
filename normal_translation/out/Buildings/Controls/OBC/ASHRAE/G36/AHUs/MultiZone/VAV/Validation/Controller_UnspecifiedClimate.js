...
// http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate
...
module.exports = (
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.opeMod
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.sumDesAreBreZon
  const sumDesAreBreZonFn = constant_baefa089({ k: 0.03 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.sumDesPopBreZon
  const sumDesPopBreZonFn = constant_baefa089({ k: 0.0125 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.vavBoxFlo2
  const vavBoxFlo2Fn = ramp_3c414377({ duration: 3600, height: 0.02, offset: 0.08 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.vavBoxFlo1
  const vavBoxFlo1Fn = ramp_3c414377({ duration: 3600, height: 0.05, offset: 0.08 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.add2
  const add2Fn = add_a5faf0f2({});
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.conAHU
  const conAHUFn = controller_6fa792b1({ ashCliZon: 0, buiPreCon: 1, ecoHigLimCon: 0, eneStd: 0, minOADes: 0, VDesTotOutAir_flow: 0.05, venStd: 0, VUncDesOutAir_flow: 0.05 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation.Controller_UnspecifiedClimate.truFalHol
