...
// http://example.org#Buildings.Controls.OBC.ASHRAE.G36.Generic.Validation.TimeSuppressionNegativeStartTime
...
module.exports = (
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.Generic.Validation.TimeSuppressionNegativeStartTime.cooSet
  const cooSetFn = ramp_3c414377({ duration: 600, height: 5, offset: 295.15, startTime: 900 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.Generic.Validation.TimeSuppressionNegativeStartTime.zonTem
  const zonTemFn = sin_9696c4d3({ amplitude: 2, freqHz: 1/7200, offset: 298.15 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.Generic.Validation.TimeSuppressionNegativeStartTime.timSupAla
  const timSupAlaFn = timesuppression_ee14a4af({ chaRat: 1080, maxTim: 7200 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.Generic.Validation.TimeSuppressionNegativeStartTime.timSupCooReq
