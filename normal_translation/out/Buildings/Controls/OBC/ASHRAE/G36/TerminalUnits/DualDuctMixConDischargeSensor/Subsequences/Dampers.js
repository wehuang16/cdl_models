...
module.exports = (
  ...
  const conHeaDamFn = pidwithreset_2293668c({ controllerType: 0, k: kHeaMaxDam, y_reset: 0, yMax: 1, yMin: 0 });
  ...
  return (
    { u1CooAHU, u1HeaAHU, uCoo, uHea, VActMin_flow, VActCooMax_flow, VActHeaMax_flow, TZon, THotSup, TColSup, VDis_flow }
  ) => {
