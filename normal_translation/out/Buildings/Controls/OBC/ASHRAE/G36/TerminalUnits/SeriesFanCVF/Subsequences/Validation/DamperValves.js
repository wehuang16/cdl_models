...
module.exports = (
  ...
  return (
    ...
    return { oveFlo: oveFlo, round1: round1, reaToInt1: reaToInt1, TDis: TDis, THeaSet: THeaSet, TSup: TSup, TSupSet: TSupSet, TZon: TZon, booPul: booPul, terFan: terFan, uCoo: uCoo, damPos: damPos, uHea: uHea, opeMod: opeMod, round2: round2, reaToInt2: reaToInt2, VActCooMax_flow: VActCooMax_flow, VActMin_flow: VActMin_flow, disAir: disAir, damValFan1: damValFan1 };
  }
}
