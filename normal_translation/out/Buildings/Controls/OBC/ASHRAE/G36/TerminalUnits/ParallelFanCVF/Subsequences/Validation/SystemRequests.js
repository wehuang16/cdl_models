...
module.exports = (
  ...
  return (
    ...
    return { sine: sine, TZonCooSet: TZonCooSet, TDis: TDis, TDisSet: TDisSet, TZon: TZon, booPul: booPul, not1: not1, uCoo: uCoo, damPos: damPos, valPos: valPos, disAir: disAir, disAirSet: disAirSet, sysReq: sysReq };
  }
}
