...
module.exports = (
  ...
  const truDel7Fn = truedelay_17dc655b({ delayTime: lowFloTim });
  ...
  const fanHotPlaOnFn = and_f2b4cf1d({});
  ...
  return (
    { TDisSet, TSup, uDam, uVal, u1HotPla, u1Fan, VActSet_flow, VDis_flow, TDis, uOpeMod }
  ) => {
    ...
    const fanHotPlaOn = fanHotPlaOnFn({ u1: u1HotPla, u2: u1Fan });
