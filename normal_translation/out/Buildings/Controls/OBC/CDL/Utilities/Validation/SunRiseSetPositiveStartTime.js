...
// http://example.org#Buildings.Controls.OBC.CDL.Utilities.Validation.SunRiseSetPositiveStartTime
const sunriseset_38197e06 = require("../SunRiseSet");

module.exports = (
  
) => {
  // http://example.org#Buildings.Controls.OBC.CDL.Utilities.Validation.SunRiseSetPositiveStartTime.sunRiseSetAntarctic
  const sunRiseSetAntarcticFn = sunriseset_38197e06({ lat: -1.3089969389957, lon: 0.99483767363677, timZon: 14400 });
  // http://example.org#Buildings.Controls.OBC.CDL.Utilities.Validation.SunRiseSetPositiveStartTime.sunRiseSetArctic
  const sunRiseSetArcticFn = sunriseset_38197e06({ lat: 1.2566370614359, lon: -1.2566370614359, timZon: -18000 });
  // http://example.org#Buildings.Controls.OBC.CDL.Utilities.Validation.SunRiseSetPositiveStartTime.sunRiseSetSf
  const sunRiseSetSfFn = sunriseset_38197e06({ lat: 0.6457718232379, lon: -2.1293016874331, timZon: -28800 });
  // http://example.org#Buildings.Controls.OBC.CDL.Utilities.Validation.SunRiseSetPositiveStartTime.sunRiseSetSyd
