...
// http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin
...
const multimin_a5ce0907 = require("../../../Buildings/Controls/OBC/CDL/Reals/MultiMin");
...
module.exports = (
  ...
  // http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin.con
  ...
  // http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin.mulMin
  const mulMinFn = multimin_a5ce0907({ nin: nZones });
  // http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin.reaScaRep
  const reaScaRepFn = realscalarreplicator_6941df46({ nout: nZones });
  // http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin.gre
  const greFn = greater_2582f78c({});
  // http://example.org#cdl_models.Controls.Subsequences.temDifSelectionMin.not1
  ...
  return (
    ...
    const gre = greFn({ u1: add2.y, u2: reaScaRep.y });
    const not1 = not1Fn({ u: gre.y });
