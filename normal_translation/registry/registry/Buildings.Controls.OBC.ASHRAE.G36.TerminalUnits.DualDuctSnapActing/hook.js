...
const controller = require("../lib/Buildings/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctSnapActing/Controller.js");
...
module.exports = async ({points, groupVariables}) => {
  ...
  const { VAdjAreBreZon_flow, VAdjPopBreZon_flow, VMinOA_flow, VSet_flow, VZonAbsMin_flow, VZonDesMin_flow, yCO2, yColDucPreResReq, yColFloSenAla, yColLeaDamAla, yCooDam, yFloSenAla, yHeaDam, yHeaFanReq, yHotDucPreResReq, yHotFloSenAla, yHotLeaDamAla, yLeaDamAla, yLowFloAla, yZonCooTemResReq, yZonHeaTemResReq } = instance(params);
