...
const controller = require("../lib/Buildings/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctMixConDischargeSensor/Controller.js");
...
module.exports = async ({points}) => {
  ...
  const { VAdjAreBreZon_flow, VAdjPopBreZon_flow, VMinOA_flow, VSet_flow, VZonAbsMin_flow, VZonDesMin_flow, yCO2, yColDucPreResReq, yCooDam, yFloSenAla, yHeaDam, yHeaFanReq, yHotDucPreResReq, yLeaDamAla, yLowFloAla, yZonCooTemResReq, yZonHeaTemResReq } = instance(params);
